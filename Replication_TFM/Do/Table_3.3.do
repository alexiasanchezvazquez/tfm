...
mi passive: g cy = ln(consumption_real)
...
winsor2 l1_debtil_y l2_debtil_y l1_debtliq_y l2_debtliq_y, cuts(1 97) by(imputation year)
winsor2 dcy dwy , cuts(2.5 97.5) by(imputation year)
...
*****************************************************************************************************************************
estout m_* using "$tables/Tab2_liquidez_rob_dlogc.txt", cells(b(fmt(%9.3f))se(par star fmt(3))) ///
