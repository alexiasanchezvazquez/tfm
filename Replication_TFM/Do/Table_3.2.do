...
winsor2 l1_debtil_y l2_debtil_y l1_debtliq_y l2_debtliq_y, cuts(1 95) by(imputation year)
winsor2 dcy dwy , cuts(5 95) by(imputation year)
...
*****************************************************************************************************************************
estout m_* using "$tables/Tab2_liquidez_rob_w95.txt", cells(b(fmt(%9.3f))se(par star fmt(3))) ///
