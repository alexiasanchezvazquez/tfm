...
* --- ATE composicion iliquida (eq. 1.3 con componente iliquido) ---
quietly summarize l1_debtil_y_w if year==2008 & ownership==2 & l1_ownership==2 & imputation==1 [aw=facine3]
scalar mDIL_2008 = r(mean)
estimates restore m_2008
lincom _b[shock] + mDIL_2008*_b[c.shock#c.l1_debtil_y_w]
scalar ateil_2008  = r(estimate)
scalar ateilse_2008 = r(se)
display "ATE iliquido 2008 = " ateil_2008 "  (SE " ateilse_2008 ")"
estadd scalar F_il
estadd scalar F_ilx
...
* --- ATE composicion iliquida (eq. 1.3 con componente iliquido) ---
quietly summarize l1_debtil_y_w if year==2011 & ownership==2 & l1_ownership==2 & imputation==1 [aw=facine3]
scalar mDIL_2011 = r(mean)
estimates restore m_2011
lincom _b[shock] + mDIL_2011*_b[c.shock#c.l1_debtil_y_w]
scalar ateil_2011  = r(estimate)
scalar ateilse_2011 = r(se)
display "ATE iliquido 2011 = " ateil_2011 "  (SE " ateilse_2011 ")"
estadd scalar F_il
estadd scalar F_ilx
...
* --- ATE composicion iliquida (eq. 1.3 con componente iliquido) ---
quietly summarize l1_debtil_y_w if year==2014 & ownership==2 & l1_ownership==2 & imputation==1 [aw=facine3]
scalar mDIL_2014 = r(mean)
estimates restore m_2014
lincom _b[shock] + mDIL_2014*_b[c.shock#c.l1_debtil_y_w]
scalar ateil_2014  = r(estimate)
scalar ateilse_2014 = r(se)
display "ATE iliquido 2014 = " ateil_2014 "  (SE " ateilse_2014 ")"
estadd scalar F_il
estadd scalar F_ilx
...
* --- ATE composicion iliquida (eq. 1.3 con componente iliquido) ---
quietly summarize l1_debtil_y_w if year==2017 & ownership==2 & l1_ownership==2 & imputation==1 [aw=facine3]
scalar mDIL_2017 = r(mean)
estimates restore m_2017
lincom _b[shock] + mDIL_2017*_b[c.shock#c.l1_debtil_y_w]
scalar ateil_2017  = r(estimate)
scalar ateilse_2017 = r(se)
display "ATE iliquido 2017 = " ateil_2017 "  (SE " ateilse_2017 ")"
estadd scalar F_il
estadd scalar F_ilx
...
* --- ATE composicion iliquida (eq. 1.3 con componente iliquido) ---
quietly summarize l1_debtil_y_w if year==2020 & ownership==2 & l1_ownership==2 & imputation==1 [aw=facine3]
scalar mDIL_2020 = r(mean)
estimates restore m_2020
lincom _b[shock] + mDIL_2020*_b[c.shock#c.l1_debtil_y_w]
scalar ateil_2020  = r(estimate)
scalar ateilse_2020 = r(se)
display "ATE iliquido 2020 = " ateil_2020 "  (SE " ateilse_2020 ")"
estadd scalar F_il
estadd scalar F_ilx
...
* --- ATE composicion iliquida (eq. 1.3 con componente iliquido) ---
quietly summarize l1_debtil_y_w if year==2022 & ownership==2 & l1_ownership==2 & imputation==1 [aw=facine3]
scalar mDIL_2022 = r(mean)
estimates restore m_2022
lincom _b[shock] + mDIL_2022*_b[c.shock#c.l1_debtil_y_w]
scalar ateil_2022  = r(estimate)
scalar ateilse_2022 = r(se)
display "ATE iliquido 2022 = " ateil_2022 "  (SE " ateilse_2022 ")"
estadd scalar F_il
estadd scalar F_ilx
...
*****************************************************************************************************************************
* TABLA RESUMEN: ATE iliquido por panel
*****************************************************************************************************************************
capture file close fB
file open fB using "$tables/Tab_ATE_illiquid.txt", write replace
file write fB "Panel & ATE (illiquid) \\" _n
foreach yr in 2008 2011 2014 2017 2020 2022 {
    local b  = string(ateil_`yr',  "%9.3f")
    local s  = string(ateilse_`yr', "%9.3f")
    file write fB "`yr' & `b' (`s') \\" _n
}
file close fB
display "ATE iliquido escrito en $tables/Tab_ATE_illiquid.txt"
