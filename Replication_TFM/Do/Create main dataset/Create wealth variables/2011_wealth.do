...
*Nota: En los resultados mostrados para 2011 en la columna “Otros activos financieros” del Cuadro 5 del documento “Encuesta Financiera de las Familias (EFF) 2011: Métodos, Resultados y Cambios desde 2008”, se incluye la tenencia de las carteras gestionadas;
*Note: The results shown for 2011 in column “Other financial assets” from Table 5 of the document “Survey of Household Finances (EFF) 2011: Methods, results and changes since 2008” include the percentage of households that own portfolios under management;
...
*Nota: En los resultados mostrados para 2011 en la columna “Otros activos financieros” del Cuadro 5 del documento “Encuesta Financiera de las Familias (EFF) 2011: Métodos, Resultados y Cambios desde 2008”, se incluye el valor de las carteras gestionadas.
*Note: The results shown for 2011 in column “Other financial assets” from Table 5 of the document “Survey of Household Finances (EFF) 2011: Methods, results and changes since 2008” include the value of the portfolios under management;
