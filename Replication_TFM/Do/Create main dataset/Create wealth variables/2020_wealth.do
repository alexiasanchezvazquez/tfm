*DEFINITIONS_2020.DOC;

*En este documento se proporcionan las definiciones de las variables utilizadas para la producción de los resultados mostrados en los cuadros del Artículo Analítico "Encuesta Financiera de las Familias (EFF) 2020: métodos, resultados y cambios desde 2017", disponible en https://www.bde.es/f/webbde/SES/Secciones/Publicaciones/InformesBoletinesRevistas/ArticulosAnaliticos/22/T3/Fich/be2203-art21.pdf Dichas variables pueden encontrarse en los ficheros de microdatos "databol" proporcionados en cada ola. 
 
*NOTA GENERAL:
*Tanto los cuadros referidos a la situación financiera de las familias en 2020 como los referidos a 2017, se proporcionan en ambos casos en euros de 2020 para variables relativas al valor de los activos, deuda, renta o gasto. Para ajustar activos y deudas a euros de 2020, los datos de la EFF2017 se han multiplicado por1,0144. Para ajustar la renta del hogar del año anterior a la encuesta a euros de 2020, los factores aplicados han sido 1,0257 para 2017 y 0,9947 para 2020;

*GENERAL NOTE:
*The tables referring to the financial position of households in 2020 and in 2017 have both been included, the variables relating to the value of assets, debt, income and spending being expressed in 2020 euro in both cases. To adjust assets and debts to 2020 euro, the EFF2017 data were multiplied by 1,0144. To adjust the household's income for the year prior to the survey to 2020 euro, the factors applied were multiplied by 1,0257 for 2017 and 0,9947 for 2020;
...
*Para renta se utiliza la variable renthog calculada como la suma de rentas laborales y no laborales de todos los miembros del hogar en el año 2019. Cuando el hogar no ha proporcionado valor para alguno de estos componentes, se lleva a cabo una imputación directa de esta renta total;
*For income the variable used is renthog. It is calculated as the sum of labour and non-labour incomes for all household members in 2019. When the household fails to provide a value for one of these components, a direct imputation of total income is performed;
...
*Nota: En los resultados mostrados para 2020 en la columna "Otros activos financieros" del Cuadro 5 del documento "Encuesta Financiera de las Familias (EFF) 2020: Métodos, Resultados y Cambios desde 2017", se incluye la tenencia de las carteras gestionadas;
*Note: The results shown for 2020 in column "Other financial assets" from Table 5 of the document "Survey of Household Finances (EFF) 2020: Methods, results and changes since 2017" include the percentage of households that own portfolios under management;

*ALGUN TIPO DE ACTIVO FINANCIERO;
*SOME TYPE OF FINANCIAL ASSET;

gen tienefin=(np4_5==1|np4_10==1|np4_18==1|np4_33==1|np4_27==1|cuentas==1|np5_1==1|seguro==1|sideuda==1|cart_gest==1|otros_af==1)
...
*Nota: En los resultados mostrados para 2020 en la columna "Otros activos financieros" del Cuadro 5 del documento "Encuesta Financiera de las Familias (EFF) 2020: Métodos, Resultados y Cambios desde 2017", se incluye el valor de las carteras gestionadas.
*Note: The results shown for 2020 in column "Other financial assets" from Table 5 of the document "Survey of Household Finances (EFF) 2020: Methods, results and changes since 2017" include the value of the portfolios under management;
