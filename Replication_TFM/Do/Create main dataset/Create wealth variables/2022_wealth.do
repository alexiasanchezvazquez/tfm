*DEFINITIONS_2022.DOC;

*En este documento se proporcionan las definiciones de las variables utilizadas para la producción de los resultados mostrados en los cuadros del Artículo Analítico "Encuesta Financiera de las Familias (EFF) 2022: métodos, resultados y cambios desde 2020", disponible en https://www.bde.es/f/webbde/SES/Secciones/Publicaciones/InformesBoletinesRevistas/ArticulosAnaliticos/22/T3/Fich/be2203-art21.pdf. Dichas variables pueden encontrarse en los ficheros de microdatos "databol" proporcionados en cada ola. Los resultados finales de las tablas mostrados en este artículo se pueden encontrar en el pdf disponible bajo el epígrafe "Cuadros de resultados principales (datos finales)".
*This document provides the definitions to the variables used for the production of the results shown in the tables of the Analytical Article "Survey of Household Finances (EFF) 2020: methods, results and changes since 2017", available in https://repositorio.bde.es/bitstream/123456789/22954/1/be2203-art21e.pdf. Such variables are available in the microdata files "databol" provided in each wave. The final results of the tables shown in the article can be found the pdf available under the heading "Tables with main results (final data)".

*NOTA GENERAL:
*Tanto los cuadros referidos a la situación financiera de las familias en 2022 como los referidos a 2020, se proporcionan en ambos casos en euros de 2022 para variables relativas al valor de los activos, deuda, renta o gasto. Para ajustar activos y deudas a euros de 2022, los datos de la EFF2020 se han multiplicado por 1,1263. Para ajustar la renta del hogar del año anterior a la encuesta a euros de 2022, los factores aplicados han sido 0,9947 para 2020 y 1,0571 para 2022;
*GENERAL NOTE:
*The tables referring to the financial position of households in 2022 and in 2020 have both been included, the variables relating to the value of assets, debt, income and spending being expressed in 2022 euro in both cases. To adjust assets and debts to 2022 euro, the EFF2020 data were multiplied by 1,1263. To adjust the household's income for the year prior to the survey to 2022 euro, the factors applied were multiplied by 0,9947 for 2020 and 1,0571 for 2022;
...
*La variable de riqueza neta (riquezanet) se define al final del programa, tras definir los diferentes activos y deudas;
*The net wealth variable (riquezanet) is defined at the end of the program, after defining the different assets and debts;

*Para renta se utiliza la variable renthog calculada como la suma de rentas laborales y no laborales de todos los miembros del hogar en el año 2021. Cuando el hogar no ha proporcionado valor para alguno de estos componentes, se lleva a cabo una imputación directa de esta renta total;
*For income the variable used is renthog. It is calculated as the sum of labour and non-labour incomes for all household members in 2021. When the household fails to provide a value for one of these components, a direct imputation of total income is performed;
...
gen np2_1=1 if (p2_1 ==2)
replace np2_1=0 if (p2_1==1| p2_1==3| p2_1==97)

*OTRAS PROPIEDADES INMOBILIARIAS;
*OTHER REAL ESTATE PROPERTIES;
*Para calcular la proporción de hogares que poseen otras propiedades inmobiliarias y que declaran un valor estrictamente positivo generamos una nueva variable;
*To calculate the percentage of households that own other real estate properties we generate a new variable; 

gen np2_32=((p2_32==1 & p2_33>=1 & p2_33~=. & p2_39_1>0 & p2_39_1~=.)|(p2_32==1 & p2_33>=2 & p2_33~=. & p2_39_2>0 & p2_39_2~=.)|(p2_32==1 & p2_33>=3 & p2_33~=. & p2_39_3>0 & p2_39_3~=.)|(p2_32==1 & p2_33>3  & p2_33~=. & p2_39_4>0 & p2_39_4~=.))
...
*Para calcular la proporción de hogares que poseen negocios por cuenta propia utilizamos las variables p4_101 y p4_111;
...
replace valhog =valhog + p4_117 if p4_101==1 & p4_117>0 & p4_117~=.
...
gen np4_27=((p4_27==1 & p4_28>=1 & p4_28~=. & p4_31_1>0 & p4_31_1~=.)|(p4_27==1 & p4_28>=2 & p4_28~=. & p4_31_2>0 & p4_31_2~=.)|(p4_27==1 & p4_28>=3 & p4_28~=. & p4_31_3>0 & p4_31_3~=.)|(p4_27==1 & p4_28>=4 & p4_28~=. & p4_31_4>0 & p4_31_4~=.)|(p4_27==1 & p4_28>=5 & p4_28~=. & p4_31_5>0 & p4_31_5~=.)|(p4_27==1 & p4_28>=6 & p4_28~=. & p4_31_6>0 & p4_31_6~=.)|(p4_27==1 & p4_28>=7 & p4_28~=. & p4_31_7>0 & p4_31_7~=.)|(p4_27==1 & p4_28>=8 & p4_28~=. & p4_31_8>0 & p4_31_8~=.)|(p4_27==1 & p4_28>=9 & p4_28~=. & p4_31_9>0 & p4_31_9~=.)|(p4_27==1 & p4_28>9 & p4_28~=. & p4_31_10>0 & p4_31_10~=.))
...
*Para calcular la proporción de hogares que poseen cuentas vivienda y/o cuentas y depósitos no utilizables para realizar pagos y que declaran un valor estrictamente positivo para el saldo de estas cuentas generamos una nueva variable;
...
*PLANES DE PENSIONES;
*PENSION SCHEMES;
*Para calcular la proporción de hogares que poseen planes de pensiones y que declaran un valor estrictamente positivo para el valor de estos planes generamos una nueva variable. Incluimos también los fondos parcialmente rescatados y los fondos que se están rescatando en la actualidad con valores actualizados positivos;
*To calculate the percentage of households that own pension schemes and that declare a strictly positive value for the balance of those pension schemes we generate a new variable. We also include partially redeemed pension schemes and pension schemes currently being redeemed with positive present values;

gen np5_1=((p5_1==1 & p5_1a>=1 & p5_1a~=. & p5_7_1>0 & p5_7_1~=.)|(p5_1==1 & p5_1a>=2 & p5_1a~=. & p5_7_2>0 & p5_7_2~=.)|(p5_1==1 & p5_1a>=3 & p5_1a~=. & p5_7_3>0 & p5_7_3~=.)|(p5_1==1 & p5_1a>=4 & p5_1a~=. & p5_7_4>0 & p5_7_4~=.)|(p5_1==1 & p5_1a>=5 & p5_1a~=. & p5_7_5>0 & p5_7_5~=.)|(p5_1==1 & p5_1a>=6 & p5_1a~=. & p5_7_6>0 & p5_7_6~=.)|(p5_1==1 & p5_1a>=7 & p5_1a~=. & p5_7_7>0 & p5_7_7~=.)|(p5_1==1 & p5_1a>=8 & p5_1a~=. & p5_7_8>0 & p5_7_8~=.)|(p5_1==1 & p5_1a>=9 & p5_1a~=. & p5_7_9>0 & p5_7_9~=.)|(p5_1==1 & p5_1a>9 & p5_1a~=. & p5_7_10>0 & p5_7_10~=.))
replace np5_1=1 if p5_26==1 & p5_27>0 & p5_27!=.
forvalues m=1/9 {
forvalues i=1/4 {
replace np5_1=1 if p6_49c_`m'_`i'>0 & p6_49c_`m'_`i'!=.
}
}
...
gen seguro=((p5_9a==1 & p5_10a>=1 & p5_10a~=. & p5_13_1==2 & p5_14_1>0 & p5_14_1~=.)|(p5_9a==1 & p5_10a>=2 & p5_10a~=. & p5_13_2==2 & p5_14_2>0 & p5_14_2~=.)|(p5_9a==1 & p5_10a>=3 & p5_10a~=. & p5_13_3==2 & p5_14_3>0 & p5_14_3~=.)|(p5_9a==1 & p5_10a>=4 & p5_10a~=. & p5_13_4==2 & p5_14_4>0 & p5_14_4~=.)|(p5_9a==1 & p5_10a>=5 & p5_10a~=. & p5_13_5==2 & p5_14_5>0 & p5_14_5~=.)|(p5_9a==1 & p5_10a>5 &   p5_10a~=. & p5_13_6==2 & p5_14_6>0 & p5_14_6~=.)|(p5_9a==1 & p5_10a>=1 & p5_10a~=. & p5_13_1==3 & p5_14_1>0 & p5_14_1~=.)|(p5_9a==1 & p5_10a>=2 & p5_10a~=. & p5_13_2==3 & p5_14_2>0 & p5_14_2~=.)|(p5_9a==1 & p5_10a>=3 & p5_10a~=. & p5_13_3==3 & p5_14_3>0 & p5_14_3~=.)|(p5_9a==1 & p5_10a>=4 & p5_10a~=. & p5_13_4==3 & p5_14_4>0 & p5_14_4~=.)|(p5_9a==1 & p5_10a>=5 & p5_10a~=. & p5_13_5==3 & p5_14_5>0 & p5_14_5~=.)|(p5_9a==1 & p5_10a>5 &   p5_10a~=. & p5_13_6==3 & p5_14_6>0 & p5_14_6~=.))
...
*Para calcular la proporción de hogares con otros activos financieros  generamos una nueva variable otros_af:
*To calculate the percentage of households with other financial assets  we generate the variable otros_af;

gen otros_af=((p4_39==1) & p4_39a>0 & p4_39a~=.)

* LO QUE SE DEBE AL HOGAR
* WHAT IS OWED TO THE HOUSEHOLD
...
gen criptos=(p4_44==1 & p4_44a>0 & p4_44a!=.)

*Nota: En los resultados mostrados para 2020 y 2022 en la columna "Otros activos financieros" del Cuadro 5 y Cuadro 5 (cont.) del documento "Encuesta Financiera de las Familias (EFF) 2022: Métodos, Resultados y Cambios desde 2020", se incluye la tenencia de las carteras gestionadas, la tenencia de otros activos financieros y lo que les deben los negocios a los distintos miembros del hogar. Además, en los resultados para 2022 - Cuadro 5 (cont.) - también se incluye la tenencia de criptomonedas (que estaban incluidas en p4_39 para 2020);
*Note: The results shown for 2020 and 2022 in column "Other financial assets" from Table 5 and Table 5 (cont.) of the document "Survey of Household Finances (EFF) 2022: Methods, results and changes since 2020" include the percentage of households that own portfolios under management, other financial assets, and households where businesses owe something to the different household members. In addition, results for 2022 - Table 5 (cont.) - also include households that own cryptocurrencies (which were included within the scope of p4_39 for 2020);

* OTROS ACTIVOS FINANCIEROS: INCLUYE CARTERAS GESTIONADAS, OTROS ACTIVOS FINANCIEROS (p4_39), LO QUE SE DEBE AL HOGAR Y CRIPTOMONEDAS.
* OTHER FINANCIAL ASSETS: INCLUDES PORTFOLIOS UNDER MANAGEMENT, OTHER FINANCIAL ASSETS (P4_39), WHAT IS OWED TO THE HOUSEHOLD AND CRYPTOCURRENCIES.
gen otros = (cart_gest==1 | otros_af==1 | sideuda==1 | criptos==1)
*ALGUN TIPO DE ACTIVO FINANCIERO;
*SOME TYPE OF FINANCIAL ASSET;

gen tienefin=(np4_5==1|np4_10==1|np4_18==1|np4_33==1|np4_27==1|cuentas==1|np5_1==1|seguro==1| cart_gest==1|otros_af==1|sideuda==1|criptos==1)
...
*FONDOS DE INVERSION;
*MUTUAL FUNDS;
*Para calcular el valor total de los fondos de inversión utilizamos la variable allf calculada como (i) la suma de los valores de cada uno de los fondos de inversión que posee el hogar (p4_31_i; i=1,…,10) si el número de estos fondos es menor o igual a 10, o si el número de estos es superior a 10 pero el valor total de los fondos de inversión declarado (p4_28a) es menor o igual a esta suma, y (ii) el valor total de los fondos de inversión del hogar (p4_28a) si posee más de 10 fondos y el valor total de los fondos de inversión declarado (p4_28a) es mayor a la suma de valores individuales;
*To obtain the total value of mutual funds we use the variable allf calculated as (i) the sum of the values of each mutual fund that the household owns (p4_31_i; i=1,…,10) if the number of these funds is 10 or less, or if the number of these funds is more than 10 but the total declared value (p4_28a) is less or equal than this sum, and (ii) the household mutual funds' total value (p4_28a) if the households owns more than 10 and mutual funds' total value (p4_28a) is larger than the sum of individual values;

gen suma_4_31=0
forv i=1/10 {
replace suma_4_31=suma_4_31 + p4_31_`i' if p4_31_`i'!=.	
}
gen     allf=.
replace allf=suma_4_31 if p4_28<=10 & p4_28!=.
replace allf=suma_4_31 if p4_28>10  & p4_28!=. & p4_28a<=suma_4_31
replace allf=p4_28a    if p4_28>10  & p4_28!=. & p4_28a>suma_4_31
...
*PLANES DE PENSIONES;
*PENSION SCHEMES;
* Para calcular el valor actualizado de los planes de pensiones utilizamos la variable valor calculada como (i) la suma de los valores de cada uno de los planes de pensiones que posee el hogar (p5_7_i; i=1,…,10) si el número de estos  planes es menor o igual a 10, o si el número de estos es superior a 10 pero el valor total de los planes de pensiones declarado (p5_7_0) es menor o igual a esta suma, (ii) el valor total de los planes de pensiones del hogar (p5_7_0) si posee más de 10 planes y el valor total de los planes de pensiones declarado (p5_7_0) es mayor a la suma de valores individuales. A este valor se añade (iii) el valor total de planes de pensiones recuperados parcialmente en el pasado (p5_27) y (iv) el valor actualizado del patrimonio que le queda por cobrar de planes que se están rescatando actualmente (p6_49c_i_j; i=1,…,9; j=1,…,3);
*To obtain the current value of the pension schemes we use the variable valor calculated as (i) the sum of the values of each pension scheme that the household owns (p5_7_i; i=1,…,10) if the number of these schemes is 10 or less, or if the number of these scheme is more than 10 but the total declared value (p5_7_0) is less or equal than this addition, (ii) the household pension schemes' total value (p5_7_0) if the households owns more than 10 and pension schemes' total value (p5_7_0) is larger than the sum of individual values. To that value we add (iii) the total current value of pension schemes partially recovered in the past (p5_27) and (iv) the current value of the equity pending collection from plans that are currently being recovered (p6_49c_i_j; i=1,…,9; j=1,…,3);

gen suma_5_7=0
forv i=1/10 {
replace suma_5_7=suma_5_7 + p5_7_`i' if p5_7_`i'!=.	
}
gen     valor=0
replace valor=suma_5_7 if p5_1a<=10 & p5_1a!=.
replace valor=suma_5_7 if p5_1a>10  & p5_1a!=. & p5_7_0<=suma_5_7
replace valor=p5_7_0    if p5_1a>10  & p5_1a!=. & p5_7_0>suma_5_7
replace valor = valor + p5_27 if   (p5_26==1 & p5_27>=0 & p5_27~=. )
forvalues m=1/9 {
forvalues i=1/4 {
replace valor = valor + p6_49c_`m'_`i' if p6_49c_`m'_`i'>0 & p6_49c_`m'_`i'!=.
}
}
...
*OTROS ACTIVOS FINANCIEROS;
*OTHER FINANCIAL ASSETS;
*Para calcular el valor de la mediana de los otros activos financieros utilizamos la variable p4_39a;
* To obtain the median of the value of other financial assets we use the variable p4_39a;
...
* CRIPTOMONEDAS;
* CRYPTOCURRENCIES;
*Para calcular el valor de las criptomonedass utilizamos la variable p4_44a;
*To obtain the value of cryptocurrencies, we use the variable p4_44a;
*Nota: En los resultados mostrados para 2020 y 2022 en la columna "Otros activos financieros" del Cuadro 5 y Cuadro 5 (cont.) del documento "Encuesta Financiera de las Familias (EFF) 2022: Métodos, Resultados y Cambios desde 2020", se incluye el valor de las carteras gestionadas la tenencia de otros activos financieros y lo que les deben los negocios a los distintos miembros del hogar. Además, en los resultados para 2022 - Cuadro 5 (cont.) - también se incluye el valor de criptomonedas (que estaba incluido en p4_39a para 2020);
*Note: The results shown for 2020 and 2022 in column "Other financial assets" from Table 5 and Table 5 (cont.) of the document "Survey of Household Finances (EFF) 2022: Methods, results and changes since 2020" include the value of the portfolios under management, other financial assets and what is owed to the household. In addition, results for 2022 - Table 5 (cont.) - also include the value of cryptocurrencies (which were included in p4_39a for 2020);

* OTROS ACTIVOS FINANCIEROS: INCLUYE CARTERAS GESTIONADAS, OTROS ACTIVOS FINANCIEROS, LO QUE SE DEBE AL HOGAR Y CRIPTOMONEDAS.
* OTHER FINANCIAL ASSETS: INCLUDES PORTFOLIOS UNDER MANAGEMENT, OTHER FINANCIAL ASSETS, WHAT IS OWED TO THE HOUSEHOLD AND CRYPTOCURRENCIES.

gen valorotros=0
replace valorotros=valorotros + p4_43 if p4_43!=.
replace valorotros=valorotros + p4_39a if p4_39a!=.
replace valorotros=valorotros + odeuhog if odeuhog!=.
replace valorotros=valorotros + p4_44a if p4_44a!=.
replace valorotros=. if valorotros==0
...
*DEUDAS CLASIFICADAS POR TIPO DE ACTIVO INMOBILIARIO (TODO TIPO DE PRÉSTAMOS);
...
*Para calcular la proporción de hogares que tienen deudas pendientes por préstamos hipotecarios y otros préstamos con garantía real generamos una nueva variable;
...
gen hipo=(p3_2_1==1| p3_2_2==1| p3_2_3==1| p3_2_4==1|p3_2_5==1| p3_2_6==1| p3_2_7==1| p3_2_8==1|p3_2_1==2| p3_2_2==2| p3_2_3==2| p3_2_4==2|p3_2_4==2|p3_2_5==2| p3_2_6==2| p3_2_7==2| p3_2_8==2|p3_2_1==10| p3_2_2==10| p3_2_3==10| p3_2_4==10|p3_2_5==10| p3_2_6==10| p3_2_7==10| p3_2_8==10)

*Para calcular el valor de las deudas pendientes por préstamos hipotecarios y otros préstamos con garantía real generamos una nueva variable;
...
*Para calcular la proporción de hogares que tienen deudas pendientes por préstamos personales generamos una nueva variable;
...
*Para calcular el valor de las deudas pendientes por préstamos personales generamos una nueva variable;
...
*Para calcular la proporción de hogares que tienen deudas pendientes con tarjetas de crédito generamos una nueva variable;
...
*Para calcular el valor de las deudas pendientes con tarjetas de crédito generamos una nueva variable;
...
replace potrasd = potrasd + p3_21 if (p3_21>0 & p3_21!=.)
...
gen adeuda= (np2_8==1|dpdte==1|p3_1>0|deuda_tarj==1)
...
replace actfinanc=actfinanc+p4_39a if (p4_39a>0 & p4_39a~=.)
replace actfinanc=actfinanc+odeuhog if (odeuhog>0 & odeuhog~=.)
replace actfinanc=actfinanc+ p4_44a if (p4_44a>0 & p4_44a~=.)
*RIQUEZA BRUTA;
*GROSS WEALTH;
...
*Para deuda por compra otras propiedades inmobiliarias usamos deuoprop;
*For debt originated by purchase of other real estate properties we use deuoprop;

*Para deudas pendientes por el resto de deudas (garantía real, crédito personal, otras deudas, deudas con tarjetas de crédito) usaremos deuotros;
...
forvalues j=1/8 {
	...
	replace pagodeusec3 = pagodeusec3 + p3_22 if (p3_22>0 & p3_22!=.)
forvalues m=1/3   {
	forvalues j=1/3 {
...
gen nodur=0
replace nodur=nodur+(p9_1*12)-alim if p9_1>0
...
*Para valor adquisición bienes duraderos usamos p2_70;
...
*Proporción con vehículos;
*Percentage with vehicles;

gen tvehic=(p2_72>0|p2_76>0)

*Mediana para los que tienen vehículos;
*Median for the ones who have vehicles; 
...
_pctile renthog [pweight=facine3], p(20,40,60,80,90)
return list

gen percrent=1 if (renthog <r(r1))
replace percrent=2 if (renthog>=r(r1) & renthog<r(r2))
replace percrent=3 if (renthog>=r(r2) & renthog<r(r3))
replace percrent=4 if (renthog>=r(r3) & renthog<r(r4))
replace percrent=5 if (renthog>=r(r4) & renthog<r(r5))
replace percrent=6 if (renthog>=r(r5) & renthog~=.)

_pctile riquezanet [pweight= facine3], p(25,50,75,90)
return list

gen percriq=1 if (riquezanet<r(r1))
replace percriq=2 if (riquezanet>=r(r1) & riquezanet<r(r2))
replace percriq=3 if (riquezanet>=r(r2) & riquezanet<r(r3))
replace percriq=4 if (riquezanet>=r(r3) & riquezanet<r(r4))
replace percriq=5 if  riquezanet>=r(r4)
