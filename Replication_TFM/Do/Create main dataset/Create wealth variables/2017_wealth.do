*DEFINITIONS_2017.DOC

*En este documento se proporcionan las definiciones de las variables utilizadas para la producción de los resultados mostrados en los cuadros del Artículo Analítico “Encuesta Financiera de las Familias (EFF) 2017: métodos, resultados y cambios desde 2014”, disponible en https://www.bde.es/bde/es/areas/estadis/estadisticas-por/encuestas-hogar/relacionados/Encuesta_Financi/eff_2017.html. Dichas variables pueden encontrarse en los ficheros de microdatos “databol” proporcionados en cada ola. 
 
*NOTA GENERAL:
*Tanto los cuadros referidos a la situación financiera de las familias en 2017 como los referidos a 2014, se proporcionan en ambos casos en euros de 2017 para variables relativas al valor de los activos, deuda, renta o gasto. Para ajustar activos y deudas a euros de 2017, los datos de la EFF2014 se han multiplicado por 1,0272. Para ajustar la renta del hogar del año anterior a la encuesta a euros de 2017, los factores aplicados han sido 1,0165 para 2014 y 1.0111 para 2017

*GENERAL NOTE:
*The tables referring to the financial position of households in 2017 and in 2014 have both been included, the variables relating to the value of assets, debt, income and spending being expressed in 2017 euro in both cases. To adjust assets and debts to 2017 euro, the EFF2014 data were multiplied by 1,0272. To adjust the household’s income for the year prior to the survey to 2017 euro, the factors applied were 1.0165 for 2014 and 1.0111 for 2017
...
*Para renta se utiliza la variable renthog calculada como la suma de rentas laborales y no laborales de todos los miembros del hogar en el año 2016. Cuando el hogar no ha proporcionado valor para alguno de estos componentes, se lleva a cabo una imputación directa de esta renta total
*For income the variable used is renthog. It is calculated as the sum of labour and non-labour incomes for all household members in 2016. When the household fails to provide a value for one of these components, a direct imputation of total income is performed
...
*Nota: En los resultados mostrados para 2017 en la columna “Otros activos financieros” del Cuadro 5 del documento “Encuesta Financiera de las Familias (EFF) 2017: Métodos, Resultados y Cambios desde 2014”, se incluye la tenencia de las carteras gestionadas
*Note: The results shown for 2017 in column “Other financial assets” from Table 5 of the document “Survey of Household Finances (EFF) 2017: Methods, results and changes since 2014” include the percentage of households that own portfolios under management
...
*Nota: En los resultados mostrados para 2017 en la columna “Otros activos financieros” del Cuadro 5 del documento “Encuesta Financiera de las Familias (EFF) 2017: Métodos, Resultados y Cambios desde 2014”, se incluye el valor de las carteras gestionadas.
*Note: The results shown for 2017 in column “Other financial assets” from Table 5 of the document “Survey of Household Finances (EFF) 2017: Methods, results and changes since 2014” include the value of the portfolios under management
...
replace actliq=actliq+p4_24 if (p4_24>0 & p4_24~=.)
replace actliq=actliq+p4_35 if (p4_35>0 & p4_35~=.)
replace actliq=actliq+allf if (allf>0 & allf~=.)
replace actliq=actliq+odeuhog if (odeuhog>0 & odeuhog~=.)
...
g actnoliq=riquezabr-actliq
g debt_liq=0
replace debt_liq=debt_liq+pperso if pperso!=.
replace debt_liq=debt_liq+ptmos_tarj if ptmos_tarj!=.
replace debt_liq=debt_liq+potrasd if potrasd!=.

g debt_noliq=0
replace debt_noliq=vdeuda-debt_liq
