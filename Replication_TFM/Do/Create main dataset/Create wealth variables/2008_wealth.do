...
gen seguro=((p5_9==1 & p5_11a>=1 & p5_11a~=. & p5_13_1==2 & p5_14_1>0 & p5_14_1~=.)|(p5_9==1 & p5_11a>=2 & p5_11a~=. & p5_13_2==2 & p5_14_2>0 & p5_14_2~=.)|(p5_9==1 & p5_11a>=3 & p5_11a~=. & p5_13_3==2 & p5_14_3>0 & p5_14_3~=.)|(p5_9==1 & p5_11a>=4 & p5_11a~=. & p5_13_4==2 & p5_14_4>0 & p5_14_4~=.)|(p5_9==1 & p5_11a>=5 & p5_11a~=. & p5_13_5==2 & p5_14_5>0 & p5_14_5~=.)|(p5_9==1 & p5_11a==6 & p5_11a~=. & p5_13_6==2 & p5_14_6>0 & p5_14_6~=.)|(p5_9==1 & p5_11a>=1 & p5_11a~=. & p5_13_1==3 & p5_14_1>0 & p5_14_1~=.)|(p5_9==1 & p5_11a>=2 & p5_11a~=. & p5_13_2==3 & p5_14_2>0 & p5_14_2~=.)|(p5_9==1 & p5_11a>=3 & p5_11a~=. & p5_13_3==3 & p5_14_3>0 & p5_14_3~=.)|(p5_9==1 & p5_11a>=4 & p5_11a~=. & p5_13_4==3 & p5_14_4>0 & p5_14_4~=.)|(p5_9==1 & p5_11a>=5 & p5_11a~=. & p5_13_5==3 & p5_14_5>0 & p5_14_5~=.)|(p5_9==1 & p5_11a>5 & p5_11a~=. & p5_13_6==3 & p5_14_6>0 & p5_14_6~=.))
...
*Nota: Los resultados mostrados para 2008 en la columna “Otros activos financieros” del Cuadro 5 del documento “Encuesta Financiera de las Familias (EFF) 2008: Métodos, Resultados y Cambios desde 2005” incluyen el porcentaje de hogares que tienen carteras gestionadas;
*Note: The results shown for 2008 in column “Other financial assets” from Table 5 of the document “Survey of Household Finances (EFF) 2008: Methods, results and changes since 2005”” include the percentage of households that own portfolios under management;
...
*Nota: Los resultados mostrados para 2008 en la columna “Otros activos financieros” del Cuadro 5 del documento “Encuesta Financiera de las Familias (EFF) 2008: Métodos, Resultados y Cambios desde 2005”, incluyen el valor de las carteras gestionadas;
*Note: The results shown for 2008 in column “Other financial assets” from Table 5 of the document “Survey of Household Finances (EFF) 2008: Methods, results and changes since 2005” include the value of the portfolios under management;
