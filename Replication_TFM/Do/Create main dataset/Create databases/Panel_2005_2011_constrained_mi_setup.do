...
use "$path/Data/panel_2005_2011_constrained.dta", clear

**********************************************************************
**********************************************************************
** Variables and multiple imputation
**********************************************************************
**********************************************************************
...
g sector=0
replace sector=1 if p6_4_1_prueba==1 & year==2005 & employment==1
replace sector=2 if p6_4_1_prueba==2 & year==2005 & employment==1 | p6_4_1_prueba==3 & year==2005 & employment==1 | p6_4_1_prueba==4 & year==2005 & employment==1
replace sector=3 if p6_4_1_prueba==5 & year==2005 & employment==1
replace sector=4 if p6_4_1_prueba>5 & year==2005 & p6_4_1_prueba!=. & employment==1

replace sector=1 if p6_4_1_prueba==1 & year==2008 & employment==1
replace sector=2 if p6_4_1_prueba==2 & year==2008 & employment==1 | p6_4_1_prueba==3 & year==2008 & employment==1 | p6_4_1_prueba==4 & year==2008 & employment==1
replace sector=3 if p6_4_1_prueba==5 & year==2008 & employment==1
replace sector=4 if p6_4_1_prueba>5 & year==2008 & p6_4_1_prueba!=. & employment==1

replace sector=1 if p6_4_1_prueba==1 & year==2011 & employment==1
replace sector=2 if p6_4_1_prueba==2 & year==2011 & employment==1 | p6_4_1_prueba==3 & year==2011 & employment==1 | p6_4_1_prueba==4 & year==2011 & employment==1 | p6_4_1_prueba==5 & year==2011 & employment==1
replace sector=3 if p6_4_1_prueba==6 & year==2011 & employment==1
replace sector=4 if p6_4_1_prueba>6 & year==2011 & p6_4_1_prueba!=. & employment==1

tab p6_4_1_prueba if year==2008 & imputation==1, mi
tab sector if year==2008 & imputation==1, mi
tab employment if year==2008 & imputation==1, mi
...
* -------------------------------------------------------------------------
* 0. Declarar el panel formalmente para rezagos
capture drop id
egen id=group(imputation h_2011)
...
g edu_h_1=0
 replace edu_h_1=1 if p1_5_1_prueba==10 | p1_5_1_prueba==11 | p1_5_1_prueba==12
...
g edu_h_pareja=0
replace edu_h_pareja=1 if p1_5_pareja==10 | p1_5_pareja==11 | p1_5_pareja==12
label variable edu_h_pareja "Educational dummy =1 if the partner has at least an University degree"
bys imputation: su edu_h_pareja

g edu_m_pareja=0
replace edu_m_pareja=1 if p1_5_pareja>=6 & p1_5_pareja<=9
label variable edu_m_pareja "Educational dummy =1 if the partner has at least la Segunda etapa de Secundaria and maximum de Bachiller"
bys imputation: su edu_m_pareja
...
ta p3_16, mi
g constraints=0
replace constraints=1 if p3_13s1==4 & p3_13s1!=. & year<2011 | p3_13s2==4 & p3_13s2!=. & year<2011 | p3_13s3==4 & p3_13s3!=. & year<2011 | p3_13s4==4 & p3_13s4!=. & year<2011 | p3_13s5==4 & p3_13s5!=. & year<2011 | p3_14>0 & p3_14!=. & year<2011 | p3_16>0 & p3_16!=. & year<2011

replace constraints=1 if p3_12a==1 & year==2011 | p3_12b==1 & year==2011 | p3_13s1==4 & year==2011 | p3_13s2==4 & year==2011 | p3_13s3==4 & year==2011 | p3_13s4==4 & year==2011 | p3_13s5==4 & year==2011
...
* Precaution
g preca_1=expect_1_prueba if year<2011
replace preca_1=1 if expect_1_prueba>50 & expect_1_prueba!=. & year==2011
...
replace interest_rate_type=1 if p2_14_1==1 & p2_8==1
...
* Main residence
replace share_fixed_rate=share_fixed_rate+p2_12_1 if p2_14_1==1 & p2_12_1>0 & p2_12_1!=.
replace share_fixed_rate=share_fixed_rate+p2_12_2 if p2_14_2==1 & p2_12_2>0 & p2_12_2!=.
replace share_fixed_rate=share_fixed_rate+p2_12_3 if p2_14_3==1 & p2_12_3>0 & p2_12_3!=.
replace share_fixed_rate=share_fixed_rate+p2_12_4 if p2_14_4==1 & p2_12_4>0 & p2_12_4!=.
* Other properties
forvalues i=1/3{
   forvalues j=1/3{
...
* Speculation
g spec_1=0
replace spec_1=1 if p2_36_1>=2005 & p2_36_1<=2008 | p2_36_2>=2005 & p2_36_2<=2008 | p2_36_3>=2005 & p2_36_3<=2008 | p2_33>3 & p2_33!=. 
...
* Income
egen nonfin_inc=rowtotal(p6_64_* p6_66_* p6_68_* p6_70_* p6_72_* p6_74_* p6_76 p6_76b p6_75b p6_75d p6_75f p6_74b_* p6_75d1 p6_75d2 p6_75d3 p6_75d4)
...
*Wealth and debt at 2011 values (Information from Bank of Spain)
foreach var of varlist  riquezanet  riquezabr actreales actfinanc vdeuda real_debt fin_debt p2_5{

g `var'_2008=`var'*1.0738 if year==2005
replace `var'_2008=`var' if year==2008

g `var'_2011=`var'_2008*1.0741 if  year==2005 | year==2008
replace `var'_2011=`var' if year==2011
...
foreach var of varlist  gage gender ownership size liqcons risk  members_working kids health_1  edu_h_1 edu_m_1   job_h_1  income_dev income_expect  cpi* mrenthog_real renthog_real consumption_real actfinanc_real actreales_real  vdeuda_real real_debt_real fin_debt_real riquezabr_real riquezanet_real durable nonfin_inc constraints precautionary contract sector employment years_house gen_constraints pending_loans number_pending_loans years_pending interest_rate interest_rate_type debt_service_real  debt_service_real_assets  debt_service_fin_assets years_pending_weight share_remaining_mortgage share_fixed_rate p2_5_real refin spec_* collateral shock {
				...
				confirm numeric variable `var'
					{
						tempvar sd
						quietly bysort h_2011 year : egen `sd'=sd(`var') 
						quietly replace `var'=. if (`sd'>0 & `sd' <.) & imputation==0 
						drop `sd'
				  } 
				}

save "$path/Data/panel_2005_2011_constrained_mi", replace
