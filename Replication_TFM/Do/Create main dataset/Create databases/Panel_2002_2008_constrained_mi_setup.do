...
use "$path/Data/panel_2002_2008_constrained.dta", clear
...
g sector=0
replace sector=1 if p6_4_1_prueba==1 & year==2002 & employment==1
replace sector=2 if p6_4_1_prueba==2 & year==2002 & employment==1 | p6_4_1_prueba==3 & year==2002 & employment==1 | p6_4_1_prueba==4 & year==2002 & employment==1
replace sector=3 if p6_4_1_prueba==5 & year==2002 & employment==1
replace sector=4 if p6_4_1_prueba>5 & year==2002 & p6_4_1_prueba!=. & employment==1
...
capture drop id
egen id=group(imputation h_2008)
...
* Interest rate related to the main mortgage
g interest_rate=0
replace interest_rate=p2_13_1 if p2_8==1
replace interest_rate=interest_rate/100 if year==2002

*Type of interest rate related to the main mortgage
...
* Speculation
g spec_1=0
replace spec_1=1 if p2_36_1>=2002 & p2_36_1<=2005 | p2_36_2>=2002 & p2_36_2<=2005 | p2_36_3>=2002 & p2_36_3<=2005 | p2_33>3 & p2_33!=. 
...
* Income
egen nonfin_inc=rowtotal(p6_64_* p6_66_* p6_68_* p6_70_* p6_72_* p6_74_* p6_76 p6_76b p6_75b p6_75d p6_75f)
...
g `var'_2008=`var'*1.1791 if year==2002
replace `var'_2008=`var'*1.0738 if year==2005
replace `var'_2008=`var' if year==2008

g `var'_2011=`var'_2008*1.0741 if year==2002 | year==2005 | year==2008
...
keep h_2008 year imputation gage gender ownership size liqcons risk  members_working kids health_1  edu_h_1 edu_m_1   job_h_1  income_dev income_expect  wt3r_* cpi* mrenthog_real renthog_real consumption_real actfinanc_real actreales_real  vdeuda_real real_debt_real fin_debt_real riquezabr_real riquezanet_real durable nonfin_inc constraints precautionary pareja contract employment sector years_house gen_constraints pending_loans number_pending_loans years_pending interest_rate interest_rate_type debt_service_real debt_service_real_assets  debt_service_fin_assets  years_pending_weight share_remaining_mortgage share_fixed_rate facine3 p2_5_real refin spec_* collateral shock
