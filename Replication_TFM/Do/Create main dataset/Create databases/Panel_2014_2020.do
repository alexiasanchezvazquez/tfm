...
* ======================================
* 4. UNIR PANEL 2014 CON 2017
* ======================================
use `eff_2014', clear
append using `eff_2017'

replace hogarpanel=0 if year==2014
sort h_2014 imputation
bys h_2014 imputation: g dd=1 if hogarpanel==1
bys h_2014 imputation: egen ddsum=sum(dd)
keep if ddsum==1

sort imputation h_2014 year
bysort imputation h_2014: replace h_2017=h_2017[2] 
...
bysort h_2017 imputation: egen ddsum=sum(dd)

keep if ddsum==2

sort imputation h_2017 year
bysort imputation h_2017: replace h_2020=h_2020[3]

egen id=group(h_2020 imputation)
xtset id year, delta(3)

bys imputation: su h_2017
...
* Se mantiene h_2020 como identificador principal del hogar al final del periodo
keep h_2020 year pan* p1 p1_1_*	p1_2b_* p2_1 p2_19 p1_3_* p1_5_* p1_7_* p6_17_*_1 p6_21_*_1 p6_1c1_* ///
...
save "$path/Data/panel_2014_2020", replace
