...
replace hogarpanel=0 if year==2005
sort h_2005 imputation
bys h_2005 imputation: g dd=1 if hogarpanel==1
bys h_2005 imputation: egen ddsum=sum(dd)
keep if ddsum==1
...
bysort imputation h_2005: replace h_2008=h_2008[2] 
...
append using `eff_2011'

drop dd ddsum
sort h_2008
sort h_2008 imputation
bys h_2008 imputation: g dd=1 if hogarpanel==1
bysort h_2008 imputation: egen ddsum=sum(dd)

keep if ddsum==2


sort imputation h_2008 year
bysort imputation h_2008: replace h_2011=h_2011[3]

egen id=group(h_2011 imputation)
xtset id year, delta(3)

bys imputation: su h_2008 h_2011

drop h_number h_2008 id
...
keep h_2011 year pan* p1 p1_1_*	p1_2b_* p2_1 p2_19 p1_3_* p1_5_* p1_7_* p6_17_*_1 p6_21_*_1 p6_1c1_* ///
p6_1c2_* p6_1c3_* p6_1c4_* p6_1c5_* p6_1c6_* p6_1c7_* p6_1c8_* p6_60g p6_60h p6_3_*  p6_4_* p6_13_*_1 ///  
 p6_63c1_*  p6_63c2_*  p6_63c3_*  p6_63c4_*  p6_63c5_*  p6_63c6_*  p6_63c7_*  p6_63c8_*  p9_1 ///
 p9_11  p9_16  renthog  mrenthog ///
 p6_64_* p6_66_* p6_68_* p6_70_* p6_72_* p6_74_* p6_76 p6_76b p6_75b p6_75d p6_75f p6_74b_* p6_75d1 p6_75d2 p6_75d3 p6_75d4  riquezanet riquezabr dvivpral deuoprop phipo  ///
 p3_13s* p3_12a p3_12b p3_14 p3_16 p6_21_*_1 ///
...
save "$path/Data/panel_2005_2011", replace
