...
replace hogarpanel=0 if year==2008
sort h_2008 imputation
bys h_2008 imputation: g dd=1 if hogarpanel==1
bys h_2008 imputation: egen ddsum=sum(dd)
keep if ddsum==1


sort imputation h_2008 year
bysort imputation h_2008: replace h_2011=h_2011[2] 
...
bysort h_2011 imputation: egen ddsum=sum(dd)

keep if ddsum==2


sort imputation h_2011 year
bysort imputation h_2011: replace h_2014=h_2014[3]

egen id=group(h_2014 imputation)
xtset id year, delta(3)

bys imputation: su h_2011
...
keep h_2014 year pan* p1 p1_1_*	p1_2b_* p2_1 p2_19 p1_3_* p1_5_* p1_7_* p6_17_*_1 p6_21_*_1 p6_1c1_* ///
...
p6_64_* p6_66_* p6_68_* p6_70_* p6_72_* p6_74_* p6_74b_* p6_75b p6_75d p6_75d1 p6_75d2 p6_75d3 p6_75d4 p6_76b p6_75f   riquezanet riquezabr dvivpral deuoprop phipo ///
...
save "$path/Data/panel_2008_2014", replace
